<?php
/**
 * This is the file that bootstraps the PHPUnit tests.
 *
 * @package Tests / Boostrap
 */
...
require_once WP_API_ROOT . '/lib/endpoints/class-wp-rest-controller.php';
